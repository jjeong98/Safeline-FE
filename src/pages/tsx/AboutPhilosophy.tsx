  ...
  const philosophies = [
    {
      ...
      description:
        "시각적 실감을 넘어 진동, 낙하, 감전 등 6종 이상의 복합 체감을 제공하여 실제와 같은 몰입 환경을 구현합니다.",
    ...
    },
    {
      ...
      description:
        "단 한 명의 교육자가 이동형 캐리어와 통합 관제 시스템(TMS)으로 수십 명의 집체 교육을 완벽하게 통제합니다.",
    ...
    },
    {
      ...
      description:
        "국내 최다 200종 이상의 산업별/사고유형별 콘텐츠와 학습관리시스템(LMS)의 데이터 분석으로 검증된 교육 효과를 제공합니다.",
        ...
        {philosophies.map((item, index) => (
          ...
          >
            <div
              ...
              style={{ backgroundImage: `url(${item.visual})` }}
            ></div>
